...
class IdP(models.Model):
    ...
    def get_acs(self):
        return self.base_url + reverse("sp-idp-acs", kwargs=self.url_params)

    get_acs.short_description = _("ACS")

    def get_slo(self):
        return self.base_url + reverse("sp-idp-slo", kwargs=self.url_params)

    get_slo.short_description = _("SLO")

    def get_absolute_url(self):
        return reverse("sp-idp-metadata", kwargs=self.url_params)

    def get_login_url(self):
        return reverse("sp-idp-login", kwargs=self.url_params)

    def get_test_url(self):
        return reverse("sp-idp-test", kwargs=self.url_params)

    def get_verify_url(self):
        return reverse("sp-idp-verify", kwargs=self.url_params)

    def get_logout_url(self):
        return reverse("sp-idp-logout", kwargs=self.url_params)
