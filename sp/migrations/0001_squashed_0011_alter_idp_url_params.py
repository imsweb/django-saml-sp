...
# sp.migrations.0006_remove_idp_slug

class Migration(migrations.Migration):

    replaces = [('sp', '0001_initial'), ('sp', '0002_auto_20191205_1758'), ('sp', '0003_auto_20200331_1934'), ('sp', '0004_auto_20200401_1328'), ('sp', '0005_auto_20210323_1526'), ('sp', '0006_remove_idp_slug'), ('sp', '0007_auto_20210323_1535'), ('sp', '0008_auto_20210323_1644'), ('sp', '0009_idpuser'), ('sp', '0010_auto_20210326_1923'), ('sp', '0011_alter_idp_url_params')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_params', models.JSONField(blank=True, default=dict, help_text='Application-specific URL path parameters.', verbose_name='URL Parameters')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, help_text='URL name or path to redirect after logout.', max_length=200),
        ),
        migrations.AddField(
            model_name='idp',
            name='logout_triggers_slo',
            field=models.BooleanField(default=False, help_text='Whether logging out should trigger a SLO request to the IdP.', verbose_name='Logout triggers SLO'),
        ),
        migrations.AddField(
            model_name='idp',
            name='state_timeout',
            field=models.IntegerField(default=60, help_text='Time (in seconds) the SAML login request state is valid for.'),
        ),
        migrations.CreateModel(
            name='IdPUser',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(default=True, verbose_name='Associate existing users with this IdP by username'),
        ),
        migrations.AddField(
            model_name='idp',
            name='username_prefix',
            field=models.CharField(blank=True, help_text='Prefix for usernames generated by this IdP', max_length=20),
        ),
        migrations.AddField(
            model_name='idp',
            name='username_suffix',
            field=models.CharField(blank=True, help_text='Suffix for usernames generated by this IdP', max_length=20),
        ),
    ]
